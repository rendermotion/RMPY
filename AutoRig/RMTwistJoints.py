...
class RMTwistJoints(object):
    ...
    def RMCreateTwist(self, TwistJoint, LookAtObject,  NumberOfTB = 3, LookAtAxis = "Y"):
        ...
        TwistJointDivide = self.NameConv.RMRenameBasedOnBaseName( TwistJoint , TwistJointDivide,  {'name' : self.NameConv.RMGetAShortName( TwistJointDivide)})
        ...
        TwistAddition = self.NameConv.RMRenameBasedOnBaseName( TwistJoint , TwistAddition,  {'name' : self.NameConv.RMGetAShortName( TwistAddition)})
        ...
        NegativeLookAtRotation = self.NameConv.RMRenameBasedOnBaseName(TwistJoint , NegativeLookAtRotation
    ...
    def RMDistanceBetweenPointsMeasure(self, Point01, Point02, name = ""):
        ...
        distanceNode = self.NameConv.RMRenameBasedOnBaseName( Point01, distanceNode, {'name': distanceNode})
    ...
    def RMStretchyTwistJoints(self):
        ...
        stretchyRefGroup = self.NameConv.RMRenameBasedOnBaseName(self.TwistOrigin, stretchyRefGroup, {'name':stretchyRefGroup})
        ...
        TwistJointDivide = self.NameConv.RMRenameBasedOnBaseName(self.TwistOrigin , TwistJointDivide,  {'name':self.NameConv.RMGetAShortName(TwistJointDivide)})
        ...
        for count in range(0,NumberOfTB + 1):
            ...
            if AlignObject:
                if self.NameConv.RMIsNameInFormat (AlignObject):
                    print 'func:::::%s' % self.NameConv.RMGetFromName(AlignObject, "name")
                    print 'Var:::::%s' % AlignObject
                    Locator[0] = self.NameConv.RMRenameBasedOnBaseName(AlignObject, Locator[0],
                            {'name': 'TwistJoint%s' % (self.NameConv.RMGetFromName(AlignObject, "name").capitalize())})#.capitalize()
