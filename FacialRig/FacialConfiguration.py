lidShapes = {"lidShapes": {
    ...
    'blendShapes': {
        ...
        "CornerInnerUp": {"connection": "CornerInnerUD", "value": 10},
    ...
    'order': ['UpLidUD', 'LowLidUD', 'UpLidSpin', 'LowLidSpin',
              # 'Spin','UpLidInOut','LowLidInOut',
...
EyeJawJoints = {"lidJoints": {
    ...
    'isSymetrical': True,
    'control': 'Character_LF_EyeLidShapes00_ctr_facialRig',
    'joints': {'Character_LF_EyeUpperLid00_sknjnt_Rig': {"connection": "UpLidUD", "inputPlug": "rotateY",
                                                         "value": [[-10, -45], [0, 0], [10, 16]]},
               "Character_LF_EyeLowerLid00_sknjnt_Rig": {"connection": "LowLidUD", "inputPlug": "rotateY",
                                                         "value": [[-10, 16], [0, 0], [10, -45]]},
               "Character_LF_EyeLidSpin00_grp_Rig": {"connection": "spin", "inputPlug": "rotateX",
...
mouth = {"mouthMain": {
    ...
    'isSymetrical': False,
    "baseMesh": "Character",
    'control': 'Character_MD_MouthShapes00_ctr_facialRig',
    ...
    'order': ['SmileFrown', 'NarrowWide', 'Ooo', 'CornerUD', 'Pinch', 'LeftRightShapes',
