...
latex_documents = [
    (master_doc, 'RMPY.tex', 'RMPY Documentation',
     'Daniel Ruiz Vargas', 'manual'),
]
...
man_pages = [
    (master_doc, 'rmpy', 'RMPY Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RMPY', 'RMPY Documentation',
     author, 'RMPY', 'One line description of project.',
     'Miscellaneous'),
]
