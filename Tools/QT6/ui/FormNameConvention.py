...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.use_name_chkBox = QtWidgets.QCheckBox(parent=Form)
        self.use_name_chkBox.setLocale(QtCore.QLocale(QtCore.QLocale.Language.English, QtCore.QLocale.Country.UnitedStates))
        self.use_name_chkBox.setText("")
        self.use_name_chkBox.setObjectName("use_name_chkBox")
        self.horizontalLayout.addWidget(self.use_name_chkBox)
    ...
    def retranslateUi(self, Form):
        ...
        self.use_name_chkBox.setToolTip(_translate("Form", "this will disabled the name line edit, and use the current name of the object."))
        self.name_label.setText(_translate("Form", " name :"))
        self.name_button.setText(_translate("Form", ">"))
        self.default_system_chkBox.setToolTip(_translate("Form", "<html><head/><body><p>Disables the system and uses the </p><p>default system name for reference points.</p></body></html>"))
