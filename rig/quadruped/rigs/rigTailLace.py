...
class RigTail(rigBase.RigBase):
    ...
    def create_point_base(self, *args, **kwargs):
        ...
        self.ik_tail.create_point_base(*args, joint_number=20, offset_vector=[1, 0, 0])
        ...
        for each in self.ik_tail.reset_controls:
            ...
            self.create.constraint.node_base(self.points_on_surface[-1].tip, each, parent=True, mo=True)
...
if __name__ == '__main__':
    root_points = pm.ls(u'C_tail00_reference_pnt', u'C_tail01_reference_pnt', u'C_tail02_reference_pnt',
