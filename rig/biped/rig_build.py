...
def visibility_switch():
    ...
    for each in {'L_bendy00_arm_grp', 'L_bendy01_arm_grp', 'L_bendy02_arm_grp',
                 'L_bendy03_arm_grp', 'L_bendy04_arm_grp', 'L_bendy05_arm_grp',
                 'R_bendy00_arm_grp', 'R_bendy01_arm_grp', 'R_bendy02_arm_grp',
                 'R_bendy03_arm_grp', 'R_bendy04_arm_grp', 'R_bendy05_arm_grp',
                 u'L_bendy00_leg_grp',
