...
class JawModel(rigFK.RigFK):
    def __init__(self):
        super(JawModel, self).__init__()


class Jaw(rigFK.RigFK):
    def __init__(self, *args, **kwargs):
        kwargs['model'] = kwargs.pop('model', JawModel())
        super(Jaw, self).__init__(*args, **kwargs)

    def create_point_base(self, *args, **kwargs):
        super(Jaw, self).create_point_base(*args, **kwargs)
