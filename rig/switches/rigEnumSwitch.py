...
class RigEnumSwitchModel(rigMultipleSwitch.RigMultipleSwitchModel):
    """
    ...
    """
    def __init__(self):
        super(RigEnumSwitchModel, self).__init__()


class RigEnumSwitch(rigMultipleSwitch.RigMultipleSwitch):
    def __init__(self, *args, **kwargs):
        kwargs['model'] = kwargs.pop('model', RigEnumSwitchModel())
    ...
    def add_enum_names(self, *enum_names, **kwargs):
        ...
        for index, each_enum in enumerate(enum_names):
            ...
            self.switch[each_enum].set_control(raise_min=float(index)-.6,
