...
def clavicleSpaceSwitch():
	...
	LFWorldFKArm = NameConv.RMRenameBasedOnBaseName (LFShoulderFK, LFWorldFKArm, NewName = "world", System = "LFKArmSpaceSwitch")
	...
	RHWorldFKArm = NameConv.RMRenameBasedOnBaseName (RHShoulderFK, RHWorldFKArm, NewName = "world", System = "RFKArmSpaceSwitch")
