...
import os
from ui import RMFormFacialLink
from FacialRig import GenericFacialRig
...
class RMFacialLink(QtGui.QDialog):
	def __init__(self, parent=None):
		super(RMFacialLink,self).__init__(parent=getMayaWindow())
